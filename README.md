# tvguide-microservice
MQTT  microservice for TV Guide Information

This microservice queries the ScedulesDirect API for one or more TV Guides
...
```
$ docker build -t tvguide-microservice .
```
...
To restart it:
```
$ docker restart tvguide-micorservice
```
